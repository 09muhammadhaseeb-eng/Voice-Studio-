...
OPENAI_API_KEY = "sk-..."
```
Then read it in `app.py` via `os.getenv("OPENAI_API_KEY", "")` — already done ✅
...
- Full live AI chat assistant (Claude gpt-4o)
...
|---|---|---|
| `OPENAI_API_KEY` | Optional* | Enables AI features (Script Writer, Enhance, Summarize) |
